const frTranslation = {
    ...
    strings: {
        ...
        'home.section.1.text': 'Je m\'appelle Maël, j\'ai % % ans et je suis passionné par l\'informatique et le développement logiciel. Je code depuis plusieurs années en apprenant surtout par la pratique et l\'expérimentation. En dehors de l\'informatique, je fais du VTT et je joue au badminton.',
