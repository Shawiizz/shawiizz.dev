...
export default function ThemeSwitcher({ className }: { className?: string }) {
    ...
    return (
        <button onClick={themeButtonClickListener} type='button' aria-label='Toggle theme'
                className={`text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 focus:outline-none rounded-full text-sm p-2.5 transition-colors duration-200 ${className}`}>
